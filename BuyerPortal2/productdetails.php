                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 block border border-dark'>
                            <div class='text-center mt-2 ''>
                                ...
                                <form actions='' method='post'>
                                    ...
                                    <div class='row'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12'> 
                                            <button name='cart' type='submit' class='btn btn-warning border-secondary addtocart' style='color:black;'><b>&nbsp&nbspAdd to cart</b><i class='fa' style='font-size:17px; '>&#61562;</i></button>
                                        </div>
                                    </div>
                                </form>
